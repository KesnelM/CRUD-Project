    ...
    >
      <Modal open={open} onClose={handleClose}>
        <Box
          ...
          gap={3}
          sx={{
            transform: 'translate(-50%, -50%)', // Correct syntax to center the modal
          }}
        >
          ...
          <Stack width="100%" direction="row" spacing={2}>
            ...
            <Button
              variant="outlined"
              onClick={() => {
                addItem(itemName); // Correct syntax for calling a function with arguments
                setItemName('');   // Resetting the itemName state
      ...
      <Stack width="800px" height="300px" spacing={2} sx={{ overflow: 'auto' }}>
  {
    inventory.map(({ name, quantity }) => (
      ...
      >
        ...
        <Button variannt="contained" onClick={()=>{
          addItem(name)
        }}
        >
          Add
